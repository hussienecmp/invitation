...
<body>
    <section class="container-fluid">
            ...
            <div class="col-md-6" style="border: 1.5rem solid #80bf7e;">
                ...
                <div class="name-cat-com">
                   <div>
                    ...
                    <p class="name"><?php echo e($name); ?></p>
                    <p class="category"><?php echo e($cat); ?></p>
                    <p class="company"><?php echo e($org?? ''); ?></p>
                  </div>
                  <div ><img src="<?php echo e(public_path('images/blue.png')); ?>" /></div>
                </div>
                <div style="position: relative; height: 20px; border-bottom: 1px dashed #4c5fa8;">
                    <div class="half-circle-green"><img src="<?php echo e(public_path('images/green.png')); ?>" />
                </div>
                </div>
                <div class="name-cat-com-add">
                    ...
                    <div style="text-align: center;">
                        <img src="<?php echo e(public_path('images/qr.png')); ?>" alt="QR Code">
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <img src="<?php echo e(public_path('images/footer1.png')); ?>" alt="Footer 1">
                <img src="<?php echo e(public_path('images/footer2.png')); ?>" alt="Footer 2">
            </div>
        </div>
    </section>
</body>
</html>
<?php /**PATH C:\invitation\resources\views/pdf/template.blade.php ENDPATH**/ ?>